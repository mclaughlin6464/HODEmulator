...
def get_training_data(fixed_params={}, directory=DIRECTORY):
    ...
    for idx, (corr_file, cov_file) in enumerate(izip(corr_files, cov_files)):
        ...
        ycovs.append(
            np.sqrt(cov / (np.outer(xi, xi))) / np.log(10))  # I think this is right, extrapolating from the above.
...
if __name__ == '__main__':
    emulation_point = [('f_c', 0.1), ('logMmin', 12.5), ('logM0', 13.0), ('sigma_logM', 0.7), ('alpha', 0.75),
                       ('logM1', 13.5)]
